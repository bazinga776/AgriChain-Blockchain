...
function getProductIds() public view returns (uint[16] memory) {
  return productIds;
}

function getProductDetail(uint prodId) public view returns (string memory,string memory,string memory,bytes32 ) {
